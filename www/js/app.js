var app = angular.module('starter', ['ionic', 'starter.controllers', 'ngCordova','ngResource','chart.js'])
    ...
    $ionicPlatform.ready(function () {
      ...
      try{
       // var db = $cordovaSQLite.openDB("DBMACROVENTAS.db");
        var db = $cordovaSQLite.openDB({ name: "ventas.db" });
  ...
  .config(function ($stateProvider, $urlRouterProvider) {
    $stateProvider
      ...
      .state('app.informacionInteres', {
        url: '/informacionInteres',
        cache:false,
        views: {
          'menuContent': {
            template: '<H1>Hola</H1>>',
      ...
      .state('app.promocionView', {
        url: '/promocion/:id',
        views: {
          'menuContent': {
            templateUrl: 'js/principal/templates/promocionView.html',
            controller: 'PromocionViewCtrl'
          }
        }
      });
    ;
